...
class HeaderDrawer extends StatefulWidget {
  HeaderDrawer({Key? key, required this.colorPrimary }): super(key: key);
  Color colorPrimary;
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.colorPrimary.withOpacity(0.3),
                width: 2
              )
            ),
            child: ClipRRect(
                borderRadius: BorderRadius.circular(10),
                child: 
                (foto_usuario == '' || foto_usuario == 'https://imagenes.gozeri.com/ImagenesGozeri/siluetas_perfil.gif')?
                const FadeInImage(
