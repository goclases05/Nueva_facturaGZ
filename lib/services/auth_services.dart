...
class AuthService extends ChangeNotifier {
  ...
  Future<String?> login(String user, String pass) async {
    ...
    final url = Uri.https(_baseUrl, '/versiones/v1.5.2/login.php');
  ...
  Future Sucursales() async {
    ...
    print(
        "https://app.gozeri.com/versiones/v1.5.2/sucursales.php?empresa=${empresa}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.2/sucursales.php?empresa=${empresa}");
  ...
  Future Series() async {
    ...
    print(
        "https://app.gozeri.com/versiones/v1.5.2/series.php?sucursal=${sucursal}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.2/series.php?sucursal=${sucursal}");
