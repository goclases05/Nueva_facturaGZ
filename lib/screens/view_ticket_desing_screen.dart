...
class ViewTicket extends StatelessWidget {
  ViewTicket({Key? key, required this.colorPrimary, required this.estado}) : super(key: key);
  Color colorPrimary;
  String estado;
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //nombre de persona
                    SimpleText(
                      'AMAYA HEYDI JUDITH SEGURA HERNÁNDEZ',
                      15,
                      TextAlign.center
                    ),
                    const SizedBox(
                    ...
                    claveValor('', '04 de Octubre de 2022', MainAxisAlignment.end),
                    const SizedBox(
                      height: 20,
                    ),
                    //n autorizacion
                    TitleText('Número de Autorización:', 13, TextAlign.center),
                    SimpleText('AF089737-62DB-4348-B2D0-CF2C3EED9A75', 13, TextAlign.center),
                    claveValor('Serie: ', 'AF089737', MainAxisAlignment.center),
                    claveValor('Número de DTE: ', '1658536776', MainAxisAlignment.center),
                    const SizedBox(
                      height: 20,
                    ),
                    //serie y no 
                    Row(
                      children: [
                        Expanded(child: claveValor('Serie:', '"Ticket"', MainAxisAlignment.start)),
                        Expanded(child: claveValor('No:', '7235', MainAxisAlignment.end))
                      ],
                    ),
                    //cliente
                    Row(
                      ...
                      children: const[
                        ...
                        Expanded(
                          child: Text('Juan Perez lopez ortiz',style: TextStyle(
                              fontSize: 15
                            ),
                            maxLines: 3,
                          ),
                    ...
                    Row(
                      ...
                      children: const[
                        ...
                        Expanded(
                          child: Text('PROMEVI SOCIEDAD ANÓNIMA',style: TextStyle(
                              fontSize: 15
                            ),
                            maxLines: 3,
                          ),
                    ...
                    Row(
                      ...
                      children: const[
                        ...
                        Expanded(
                          child: Text('CALZADA AGUILAR BATRES 16-29 1 REFORMITA GUATEMALA ',style: TextStyle(
                              fontSize: 15
                            ),
                            maxLines: 3,
                          ),
                    ...
                    claveValor('Efectivo: ', 'Q200.00', MainAxisAlignment.center),
                    const SizedBox(
                      height: 20,
                    ),
                    ListTile(
                    ...
                    Container(
                      ...
                      child: claveValor('Descuentos (-) :  ', 'Q2.00', MainAxisAlignment.end)
                    ),
                    //total
                    Container(
                      margin: EdgeInsets.only(right: 20),
                      child: claveValor('Total :  ', 'Q200.00', MainAxisAlignment.end)
                    ),
                    const SizedBox(
                      height: 15,
                    ),
                    //total letra
                    claveValor('noventa con 00/100', '', MainAxisAlignment.start),
                    //isr
                    const SizedBox(
                      height: 15,
                    ),
                    SimpleText('Sujeto a pagos trimestrales ISR', 15, TextAlign.center),
                    const SizedBox(
                      height: 15,
                    ),
                    claveValor('Certificador: ', 'Megaprint, S.A.', MainAxisAlignment.start),
                    claveValor('NIT: ', '50510231', MainAxisAlignment.start),
                    claveValor('Fecha: ', '2022-10-04T11:30:32.465-06:00', MainAxisAlignment.start),
                    //creditos xd
                    const SizedBox(
                      height: 15,
                    ),
                    SimpleText('Factura realizada en www.gozeri.com', 15, TextAlign.center)
                  ],
                ),
              ),
            ),
  ...
  Container sheetButton(BuildContext context) {
    return Container(
        color: Color.fromRGBO(246,243,244,1),
  ...
  Row claveValor(String clave, String valor, MainAxisAlignment align) {
    return Row(
      ...
      children: [
        Text(clave,style: const TextStyle(
            fontWeight: FontWeight.bold,
            fontSize: 15,
        wordSpacing:0
          )
