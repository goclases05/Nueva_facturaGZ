                ...
                //Image.asset('assets/gozeri_blanco2.png',color: Colors.cyan.withOpacity(0.3), width: MediaQuery.of(context).size.width*0.3,),
                 Card(
                  ...
                  child: Container(
                    ...
                    child: Icon(Icons.settings,color: Colors.cyan, size: 120,)
                    )
                ),
                const SizedBox(height: 10,),
                const Text('Sistema en Mantenimiento',style: TextStyle(color: Colors.cyan, fontSize: 25), textAlign: TextAlign.center),
                const Text('Por el momento nuestro sistema se encuentra en mantenimiento. Esto puede demorar varios minutos',textAlign: TextAlign.center,),
                SizedBox(
