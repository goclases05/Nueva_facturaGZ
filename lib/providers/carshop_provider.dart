...
class Cart with ChangeNotifier {
  ...
  Future<String> HttpCart(id_prod, cantidad_p, id_tmp, precio) async {
    ...
    print(
        "https://${_baseUrl}/versiones/v1.5.3/factura/add_cart_factura.php?id_prod=${id_prod}&id_fact=${id_tmp}&idusuario=${id_usuario}&cantida=${cantidad_p}&precio=${precio}&usuario=${id_usuario}");
