...
class Facturacion extends ChangeNotifier {
  ...
  Future serie(String tmp, String accion, String serie) async {
    if (accion == 'read') {
      ...
      notifyListeners();
      print(
          "https://app.gozeri.com/versiones/v1.5.0/factura/serie_tmp.php?tmp=${tmp}&accion=read");
      ...
      print(
          "https://app.gozeri.com/versiones/v1.5.0/factura/serie_tmp.php?tmp=${tmp}&accion=add&serie=${serie}");
      final Uri uri = Uri.parse(
          "https://app.gozeri.com/versiones/v1.5.0/factura/serie_tmp.php?tmp=${tmp}&accion=add&serie=${serie}");
  ...
  Future metodoPago() async {
    ...
    loadMetodo = true;
    notifyListeners();
    print("https://app.gozeri.com/versiones/v1.5.0/metodoPago.php");
    final Uri uri =
        Uri.parse("https://app.gozeri.com/versiones/v1.5.0/metodoPago.php");
  ...
  Future transacciones(String tmp) async {
    ...
    notifyListeners();
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/transacciones.php?id=${tmp}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/transacciones.php?id=${tmp}");
  ...
  Future accionesMetodoPAgo(
    ...
    if (accion == 'add') {
      print(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_metodoPago.php?accion=${accion}&tmp=${tmp}&abono=${abono}&id_usuario=${usuario}&metodo=${metodo}&cuenta=${cuenta}&referencia=${referencia}&empresa=${empresa}");
      final Uri uri = Uri.parse(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_metodoPago.php?accion=${accion}&tmp=${tmp}&abono=${abono}&id_usuario=${usuario}&metodo=${metodo}&cuenta=${cuenta}&referencia=${referencia}&empresa=${empresa}");
  ...
  Future facturar(String tmp) async {
    ...
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/certificar_core.php?id=${tmp}&usuario=${id_usuario}&empresa=${empresa}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/certificar_core.php?id=${tmp}&usuario=${id_usuario}&empresa=${empresa}");
  ...
  Future anular_factura(String id_f) async {
    ...
    final id_usuario = Preferencias.data_id;
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/anulacion_factura.php?id=${id_f}&usuario=${id_usuario}&empresa=${empresa}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/anulacion_factura.php?id=${id_f}&usuario=${id_usuario}&empresa=${empresa}");
  ...
  Future bancos() async {
    ...
    notifyListeners();
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/bancos.php?empresa=${empresa}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/bancos.php?empresa=${empresa}");
  ...
  Future<dynamic> new_tmpFactura() async {
    ...
    print(
        "https://${_baseUrl}/versiones/v1.5.0/factura/new_tmp_factura.php?empresa=${empresa}&id_usuario=${id_usuario}&sucu=${Preferencias.sucursal}");
    final Uri uri = Uri.parse(
        "https://${_baseUrl}/versiones/v1.5.0/factura/new_tmp_factura.php?empresa=${empresa}&id_usuario=${id_usuario}&sucu=${Preferencias.sucursal}");
  ...
  Future<dynamic> list_cart(String id) async {
    ...
    print(
        "https://${_baseUrl}/versiones/v1.5.0/factura/read_det_factura.php?id_tmp=${id}&id_empresa=${empresa}");
    final Uri uri = Uri.parse(
        "https://${_baseUrl}/versiones/v1.5.0/factura/read_det_factura.php?id_tmp=${id}&id_empresa=${empresa}");
  ...
  Future<dynamic> delete_producto(String id_tmp, String id_item) async {
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/edit_articulo_detalle_car.php?id_tmp=${id_tmp}&id_item=${id_item}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/edit_articulo_detalle_car.php?id_tmp=${id_tmp}&id_item=${id_item}");
  ...
  Future<dynamic> delete_transaccion(String id_tmp, String trans) async {
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/fac_metodoPago.php?id_tmp=${id_tmp}&id_trans=${trans}&accion=delete");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/fac_metodoPago.php?id_tmp=${id_tmp}&id_trans=${trans}&accion=delete");
  ...
  Future<dynamic> read_cliente(
    ...
    if (accion == 'read') {
      ...
      print(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_cliente.php?tmp=${tmp}&accion=read");
      final Uri uri = Uri.parse(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_cliente.php?tmp=${tmp}&accion=read");
      ...
      print(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_cliente.php?tmp=${tmp}&accion=remove&cliente=${id_cliente}");
      final Uri uri = Uri.parse(
          "https://app.gozeri.com/versiones/v1.5.0/factura/fac_cliente.php?tmp=${tmp}&accion=remove&cliente=${id_cliente}");
  ...
  Future<dynamic> create_cliente(
    ...
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/create_cliente.php?tmp=${tmp}&nombre=${nombre}&apellidos=${apellidos}&nit=${nit}&idempresa=${empresa}&idusuario=${id_usuario}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/create_cliente.php?tmp=${tmp}&nombre=${nombre}&apellidos=${apellidos}&nit=${nit}&idempresa=${empresa}&idusuario=${id_usuario}");
  ...
  Future<String> delete_tmp(String tmp) async {
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/eliminar_factura.php?id=${tmp}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/eliminar_factura.php?id=${tmp}");
  ...
  Future<dynamic> get_Sat(String tmp, String nit) async {
    ...
    cambio_c = '0';
    print(
        "https://app.gozeri.com/versiones/v1.5.0/factura/search_cliente_sat.php?SAT=${nit}&empresa=${empresa}&idusuario=${id_usuario}");
    final Uri uri = Uri.parse(
        "https://app.gozeri.com/versiones/v1.5.0/factura/search_cliente_sat.php?SAT=${nit}&empresa=${empresa}&idusuario=${id_usuario}");
